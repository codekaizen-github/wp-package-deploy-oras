...
namespace CodekaizenGithub\WPPackageDeployORAS\Value\CommonPackageMeta;
 ...
 * Undocumented class
 */
class EnvironmentCommonPackageMetaValue implements EnvironmentCommonPackageMetaValueContract {
	/**
